...
blog-publish: true
title: "position"
description: "static 正常的布局行为。 relative 就是给原先的位置进行偏移，但是原先那里会留白。仍在正常文档流内。 absolute 给原先的位置进行偏移，但是原先那里不会留白。margin不会和别的合并。 fixed 相对屏幕绝对定位。"
pubDate: 2026-06-23
---
