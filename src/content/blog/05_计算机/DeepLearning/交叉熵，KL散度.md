...
blog-publish: true
title: "交叉熵，KL散度"
description: "https://zhuanlan.zhihu.com/p/573385147 概率的倒数可以被称为“惊喜度（信息量）”，为使确定事件的“惊喜度”为0我们取个对数。 [!todo] 信息论 $$ s(x)=\\log \\left( \\fr..."
pubDate: 2026-08-08
---
...
概率的倒数可以被称为“惊喜度（信息量）”，为使确定事件的“惊喜度”为0我们取个对数。
